        ...
        <div className={styles.all}>
          <div className={styles.options}>
            ...
            <div
              ...
              style={{
                backgroundColor:
                  fase == 3.1 || fase == 3.2 || fase == 3.3 ? "rgba(0, 0, 0, 0.2)" : "rgba(0, 0, 0, 0.08)",
              }}
              onClick={() => setFase(3.1)}
            >
              Fase 3
            ...
            <div
              ...
              style={{
                backgroundColor:
                  fase == 4.1 || fase == 4.2 ? "rgba(0, 0, 0, 0.2)" : "rgba(0, 0, 0, 0.08)",
              }}
              onClick={() => setFase(4.1)}
            >
              Fase 4
          ...
          <div className={styles.fases}>
              ...
              <div className={styles.fase}>
                ...
                <div className={styles.videoItem}>
                  ...
                  <div className={styles.botoes}>
                    ...
                    <div className={styles.link}>
                      <button onClick={() => { setFase(4.2) }} className={styles.button}>
                        Jogo de Fixação
                      </button>
                    </div>
                  </div>
            ...
            {fase == 4.2 && (<Hangman setFase={setFase} />)}
