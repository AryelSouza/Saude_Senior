...
export default function Capacitacao() {
  ...
  const [answers, setAnswers] = useState([
    { question: 1, userAnswer: null, isCorrect: null },
    { question: 2, userAnswer: null, isCorrect: null },
    { question: 3, userAnswer: null, isCorrect: null },
    { question: 4, userAnswer: null, isCorrect: null },
    { question: 5, userAnswer: null, isCorrect: null },
  ]);
        ...
        <div className={styles.all}>
          ...
          {fase == 1.4 && (
            ...
            <div className={styles.question}>
              <p className={isAnswerCorrect === true ? 'correct' : 'incorrect'}>
                {isAnswerCorrect === true && "Muito bem, você assinalou a resposta correta."}
                {isAnswerCorrect === false && "Resposta correta: Letra A. Tendo em vista, que essa política não foi mencionada em nossa formação. Além disso, seu público alvo são crianças, pois como sua nomenclatura completa descreve, refere-se a Política Nacional de Atenção Integral à Saúde da Criança."}
              </p>
              <p>
              ...
              <p className={isAnswerCorrect === true ? 'correct' : 'incorrect'}>
                {isAnswerCorrect === true && "Muito bem, você assinalou a resposta correta."}
                {isAnswerCorrect === false && "Resposta correta: Letra B. Por mais que seus objetivos sejam os mesmos, cada política de saúde se caracteriza de uma forma diferente, porém complementar. Em caso de dúvidas, retorne ao nosso segundo vídeo de conteúdo ou acesse o material disponível, para mais detalhes.."}
              </p>
              <p>
